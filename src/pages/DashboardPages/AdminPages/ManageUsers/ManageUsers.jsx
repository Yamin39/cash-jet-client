              ...
              <tbody>
                {users.map((user) => (
                  <tr key={user?._id} className="odd:bg-white even:bg-gray-50 border-b">
                    <td className="px-6 py-4 md:max-w-[17.8125rem] word-break-all">{user?.name}</td>
                    <td className="px-6 py-4 md:max-w-[17.8125rem] word-break-all">{user?.email}</td>
                    <td className="px-6 py-4 md:max-w-[17.8125rem] word-break-all">{user?.mobileNumber}</td>
